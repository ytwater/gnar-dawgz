 ...
 */
import type { ConversationsV1ServiceServiceUserLinks } from "./conversationsV1ServiceServiceUserLinks";

export interface ConversationsV1ServiceServiceUser {
	/**
	...
	url?: string | null;
	/** @nullable */
	links?: ConversationsV1ServiceServiceUserLinks;
}
