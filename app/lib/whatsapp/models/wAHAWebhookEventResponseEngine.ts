...
export type WAHAWebhookEventResponseEngine =
	(typeof WAHAWebhookEventResponseEngine)[keyof typeof WAHAWebhookEventResponseEngine];

export const WAHAWebhookEventResponseEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
