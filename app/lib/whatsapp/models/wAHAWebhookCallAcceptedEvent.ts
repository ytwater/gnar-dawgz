 ...
 */
export type WAHAWebhookCallAcceptedEvent =
	(typeof WAHAWebhookCallAcceptedEvent)[keyof typeof WAHAWebhookCallAcceptedEvent];

export const WAHAWebhookCallAcceptedEvent = {
