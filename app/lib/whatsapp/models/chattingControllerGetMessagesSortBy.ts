...
export type ChattingControllerGetMessagesSortBy =
	(typeof ChattingControllerGetMessagesSortBy)[keyof typeof ChattingControllerGetMessagesSortBy];

export const ChattingControllerGetMessagesSortBy = {
	timestamp: "timestamp",
