...
export type WAHAWebhookCallAcceptedEngine =
	(typeof WAHAWebhookCallAcceptedEngine)[keyof typeof WAHAWebhookCallAcceptedEngine];

export const WAHAWebhookCallAcceptedEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
