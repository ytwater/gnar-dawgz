 ...
 * @deprecated
 */
export type WAHAWebhookStateChangeEvent =
	(typeof WAHAWebhookStateChangeEvent)[keyof typeof WAHAWebhookStateChangeEvent];

export const WAHAWebhookStateChangeEvent = {
