...
export type WAHAWebhookPollVoteFailedEngine =
	(typeof WAHAWebhookPollVoteFailedEngine)[keyof typeof WAHAWebhookPollVoteFailedEngine];

export const WAHAWebhookPollVoteFailedEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
