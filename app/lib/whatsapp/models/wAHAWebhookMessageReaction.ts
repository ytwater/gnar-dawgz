...
import type { WAHAWebhookMessageReactionEngine } from "./wAHAWebhookMessageReactionEngine";
import type { WAHAWebhookMessageReactionEvent } from "./wAHAWebhookMessageReactionEvent";
import type { WAHAWebhookMessageReactionMetadata } from "./wAHAWebhookMessageReactionMetadata";
...
export interface WAHAWebhookMessageReaction {
	...
	metadata?: WAHAWebhookMessageReactionMetadata;
	engine: WAHAWebhookMessageReactionEngine;
	/** The event is triggered when a user reacts or removes a reaction. */
	event: WAHAWebhookMessageReactionEvent;
