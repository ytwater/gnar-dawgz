...
export type WAHAWebhookEngineEventEngine =
	(typeof WAHAWebhookEngineEventEngine)[keyof typeof WAHAWebhookEngineEventEngine];

export const WAHAWebhookEngineEventEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
