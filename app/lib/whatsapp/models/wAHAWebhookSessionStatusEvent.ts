 ...
 */
export type WAHAWebhookSessionStatusEvent =
	(typeof WAHAWebhookSessionStatusEvent)[keyof typeof WAHAWebhookSessionStatusEvent];

export const WAHAWebhookSessionStatusEvent = {
