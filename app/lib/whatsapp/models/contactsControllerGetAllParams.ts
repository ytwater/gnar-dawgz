 ...
 */
import type { ContactsControllerGetAllSortBy } from "./contactsControllerGetAllSortBy";
import type { ContactsControllerGetAllSortOrder } from "./contactsControllerGetAllSortOrder";

export type ContactsControllerGetAllParams = {
	session?: string;
	/**
	 * Sort by field
	 */
	sortBy?: ContactsControllerGetAllSortBy;
	/**
	 * Sort order - <b>desc</b>ending (Z => A, New first) or <b>asc</b>ending (A => Z, Old first)
	 */
	sortOrder?: ContactsControllerGetAllSortOrder;
	limit?: number;
	offset?: number;
};
