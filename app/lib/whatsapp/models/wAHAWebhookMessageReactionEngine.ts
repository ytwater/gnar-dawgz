...
export type WAHAWebhookMessageReactionEngine =
	(typeof WAHAWebhookMessageReactionEngine)[keyof typeof WAHAWebhookMessageReactionEngine];

export const WAHAWebhookMessageReactionEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
