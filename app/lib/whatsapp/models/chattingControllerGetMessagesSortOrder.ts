...
export type ChattingControllerGetMessagesSortOrder =
	(typeof ChattingControllerGetMessagesSortOrder)[keyof typeof ChattingControllerGetMessagesSortOrder];

export const ChattingControllerGetMessagesSortOrder = {
	desc: "desc",
	asc: "asc",
} as const;
