...
import type { WebhookGroupV2JoinEngine } from "./webhookGroupV2JoinEngine";
import type { WebhookGroupV2JoinEvent } from "./webhookGroupV2JoinEvent";
import type { WebhookGroupV2JoinMetadata } from "./webhookGroupV2JoinMetadata";
...
export interface WebhookGroupV2Join {
	...
	metadata?: WebhookGroupV2JoinMetadata;
	engine: WebhookGroupV2JoinEngine;
	/** When you joined or were added to a group */
	event: WebhookGroupV2JoinEvent;
