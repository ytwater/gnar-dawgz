...
import type { WAHAWebhookMessageAnyEngine } from "./wAHAWebhookMessageAnyEngine";
import type { WAHAWebhookMessageAnyEvent } from "./wAHAWebhookMessageAnyEvent";
import type { WAHAWebhookMessageAnyMetadata } from "./wAHAWebhookMessageAnyMetadata";
...
export interface WAHAWebhookMessageAny {
	...
	metadata?: WAHAWebhookMessageAnyMetadata;
	engine: WAHAWebhookMessageAnyEngine;
	/** Fired on all message creations, including your own. */
	event: WAHAWebhookMessageAnyEvent;
	payload: WAMessage;
	me?: MeInfo;
