...
export type WebhookGroupV2UpdateEngine =
	(typeof WebhookGroupV2UpdateEngine)[keyof typeof WebhookGroupV2UpdateEngine];

export const WebhookGroupV2UpdateEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
