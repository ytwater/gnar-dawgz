...
export type WAHAWebhookGroupLeaveEngine =
	(typeof WAHAWebhookGroupLeaveEngine)[keyof typeof WAHAWebhookGroupLeaveEngine];

export const WAHAWebhookGroupLeaveEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
