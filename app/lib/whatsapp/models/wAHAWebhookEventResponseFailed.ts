...
import type { WAHAWebhookEventResponseFailedEngine } from "./wAHAWebhookEventResponseFailedEngine";
import type { WAHAWebhookEventResponseFailedEvent } from "./wAHAWebhookEventResponseFailedEvent";
import type { WAHAWebhookEventResponseFailedMetadata } from "./wAHAWebhookEventResponseFailedMetadata";
...
export interface WAHAWebhookEventResponseFailed {
	...
	metadata?: WAHAWebhookEventResponseFailedMetadata;
	engine: WAHAWebhookEventResponseFailedEngine;
	/** The event is triggered when the event response is failed to decrypt. */
	event: WAHAWebhookEventResponseFailedEvent;
