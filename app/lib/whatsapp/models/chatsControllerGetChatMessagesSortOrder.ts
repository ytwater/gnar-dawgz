...
export type ChatsControllerGetChatMessagesSortOrder =
	(typeof ChatsControllerGetChatMessagesSortOrder)[keyof typeof ChatsControllerGetChatMessagesSortOrder];

export const ChatsControllerGetChatMessagesSortOrder = {
	desc: "desc",
	asc: "asc",
} as const;
