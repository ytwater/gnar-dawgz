...
import type { WAHAWebhookCallReceivedEngine } from "./wAHAWebhookCallReceivedEngine";
import type { WAHAWebhookCallReceivedEvent } from "./wAHAWebhookCallReceivedEvent";
import type { WAHAWebhookCallReceivedMetadata } from "./wAHAWebhookCallReceivedMetadata";
...
export interface WAHAWebhookCallReceived {
	...
	metadata?: WAHAWebhookCallReceivedMetadata;
	engine: WAHAWebhookCallReceivedEngine;
	/** The event is triggered when the call is received by the user. */
	event: WAHAWebhookCallReceivedEvent;
	payload: CallData;
	me?: MeInfo;
