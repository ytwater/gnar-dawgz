...
export type SessionsControllerGetExpandItem =
	(typeof SessionsControllerGetExpandItem)[keyof typeof SessionsControllerGetExpandItem];

export const SessionsControllerGetExpandItem = {
	apps: "apps",
} as const;
