...
export type WAHAWebhookChatArchiveEngine =
	(typeof WAHAWebhookChatArchiveEngine)[keyof typeof WAHAWebhookChatArchiveEngine];

export const WAHAWebhookChatArchiveEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
