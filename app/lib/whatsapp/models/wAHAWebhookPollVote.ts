...
import type { WAHAWebhookPollVoteEngine } from "./wAHAWebhookPollVoteEngine";
import type { WAHAWebhookPollVoteEvent } from "./wAHAWebhookPollVoteEvent";
import type { WAHAWebhookPollVoteMetadata } from "./wAHAWebhookPollVoteMetadata";
...
export interface WAHAWebhookPollVote {
	...
	metadata?: WAHAWebhookPollVoteMetadata;
	engine: WAHAWebhookPollVoteEngine;
	/** With this event, you receive new votes for the poll sent. */
	event: WAHAWebhookPollVoteEvent;
