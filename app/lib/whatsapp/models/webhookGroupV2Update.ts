...
import type { WebhookGroupV2UpdateEngine } from "./webhookGroupV2UpdateEngine";
import type { WebhookGroupV2UpdateEvent } from "./webhookGroupV2UpdateEvent";
import type { WebhookGroupV2UpdateMetadata } from "./webhookGroupV2UpdateMetadata";
...
export interface WebhookGroupV2Update {
	...
	metadata?: WebhookGroupV2UpdateMetadata;
	engine: WebhookGroupV2UpdateEngine;
	/** When group info is updated */
	event: WebhookGroupV2UpdateEvent;
