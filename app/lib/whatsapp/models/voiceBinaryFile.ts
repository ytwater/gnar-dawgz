 ...
 */
import type { VoiceBinaryFileFilename } from "./voiceBinaryFileFilename";
import type { VoiceBinaryFileMimetype } from "./voiceBinaryFileMimetype";

export interface VoiceBinaryFile {
	/** MIME type of the attachment. */
	mimetype: VoiceBinaryFileMimetype;
	/** Document file name. Optional */
	filename: VoiceBinaryFileFilename;
