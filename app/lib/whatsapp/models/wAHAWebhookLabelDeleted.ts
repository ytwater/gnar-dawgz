...
import type { WAHAWebhookLabelDeletedEngine } from "./wAHAWebhookLabelDeletedEngine";
import type { WAHAWebhookLabelDeletedEvent } from "./wAHAWebhookLabelDeletedEvent";
import type { WAHAWebhookLabelDeletedMetadata } from "./wAHAWebhookLabelDeletedMetadata";
...
export interface WAHAWebhookLabelDeleted {
	...
	metadata?: WAHAWebhookLabelDeletedMetadata;
	engine: WAHAWebhookLabelDeletedEngine;
	/** The event is triggered when a label is deleted */
	event: WAHAWebhookLabelDeletedEvent;
	payload: Label;
	me?: MeInfo;
