...
export type WAHAWebhookMessageAckGroupEngine =
	(typeof WAHAWebhookMessageAckGroupEngine)[keyof typeof WAHAWebhookMessageAckGroupEngine];

export const WAHAWebhookMessageAckGroupEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
