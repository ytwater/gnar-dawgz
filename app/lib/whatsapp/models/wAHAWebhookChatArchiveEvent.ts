 ...
 */
export type WAHAWebhookChatArchiveEvent =
	(typeof WAHAWebhookChatArchiveEvent)[keyof typeof WAHAWebhookChatArchiveEvent];

export const WAHAWebhookChatArchiveEvent = {
