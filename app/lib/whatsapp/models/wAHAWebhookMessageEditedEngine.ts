...
export type WAHAWebhookMessageEditedEngine =
	(typeof WAHAWebhookMessageEditedEngine)[keyof typeof WAHAWebhookMessageEditedEngine];

export const WAHAWebhookMessageEditedEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
