 ...
 */
export type WAHAWebhookMessageAckEvent =
	(typeof WAHAWebhookMessageAckEvent)[keyof typeof WAHAWebhookMessageAckEvent];

export const WAHAWebhookMessageAckEvent = {
