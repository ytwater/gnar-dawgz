 ...
 */
export type WAHAWebhookCallRejectedEvent =
	(typeof WAHAWebhookCallRejectedEvent)[keyof typeof WAHAWebhookCallRejectedEvent];

export const WAHAWebhookCallRejectedEvent = {
