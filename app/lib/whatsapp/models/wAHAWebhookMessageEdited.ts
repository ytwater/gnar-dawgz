...
import type { WAHAWebhookMessageEditedEngine } from "./wAHAWebhookMessageEditedEngine";
import type { WAHAWebhookMessageEditedEvent } from "./wAHAWebhookMessageEditedEvent";
import type { WAHAWebhookMessageEditedMetadata } from "./wAHAWebhookMessageEditedMetadata";
...
export interface WAHAWebhookMessageEdited {
	...
	metadata?: WAHAWebhookMessageEditedMetadata;
	engine: WAHAWebhookMessageEditedEngine;
	/** The event is triggered when a user edits a previously sent message. */
	event: WAHAWebhookMessageEditedEvent;
