...
import type { WAHAWebhookGroupLeaveEngine } from "./wAHAWebhookGroupLeaveEngine";
import type { WAHAWebhookGroupLeaveEvent } from "./wAHAWebhookGroupLeaveEvent";
import type { WAHAWebhookGroupLeaveMetadata } from "./wAHAWebhookGroupLeaveMetadata";
import type { WAHAWebhookGroupLeavePayload } from "./wAHAWebhookGroupLeavePayload";
...
export interface WAHAWebhookGroupLeave {
	...
	metadata?: WAHAWebhookGroupLeaveMetadata;
	engine: WAHAWebhookGroupLeaveEngine;
	/**
	 * Some one left a group.
	 * @deprecated
	 */
	event: WAHAWebhookGroupLeaveEvent;
	payload: WAHAWebhookGroupLeavePayload;
	me?: MeInfo;
