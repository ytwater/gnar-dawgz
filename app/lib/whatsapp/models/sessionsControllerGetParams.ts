 ...
 */
import type { SessionsControllerGetExpandItem } from "./sessionsControllerGetExpandItem";

export type SessionsControllerGetParams = {
	/**
	 * Expand additional session details.
	 */
	expand?: SessionsControllerGetExpandItem[];
};
