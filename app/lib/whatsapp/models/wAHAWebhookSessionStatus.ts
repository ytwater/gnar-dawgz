...
import type { WAHAWebhookSessionStatusEngine } from "./wAHAWebhookSessionStatusEngine";
import type { WAHAWebhookSessionStatusEvent } from "./wAHAWebhookSessionStatusEvent";
import type { WAHAWebhookSessionStatusMetadata } from "./wAHAWebhookSessionStatusMetadata";
...
export interface WAHAWebhookSessionStatus {
	...
	metadata?: WAHAWebhookSessionStatusMetadata;
	engine: WAHAWebhookSessionStatusEngine;
	/** The event is triggered when the session status changes. */
	event: WAHAWebhookSessionStatusEvent;
