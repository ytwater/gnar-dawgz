 ...
 */
export type WAHAWebhookPollVoteFailedEvent =
	(typeof WAHAWebhookPollVoteFailedEvent)[keyof typeof WAHAWebhookPollVoteFailedEvent];

export const WAHAWebhookPollVoteFailedEvent = {
