...
export type WAHAWebhookCallReceivedEngine =
	(typeof WAHAWebhookCallReceivedEngine)[keyof typeof WAHAWebhookCallReceivedEngine];

export const WAHAWebhookCallReceivedEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
