...
import type { WAHAWebhookStateChangeEngine } from "./wAHAWebhookStateChangeEngine";
import type { WAHAWebhookStateChangeEvent } from "./wAHAWebhookStateChangeEvent";
import type { WAHAWebhookStateChangeMetadata } from "./wAHAWebhookStateChangeMetadata";
import type { WAHAWebhookStateChangePayload } from "./wAHAWebhookStateChangePayload";
...
export interface WAHAWebhookStateChange {
	...
	metadata?: WAHAWebhookStateChangeMetadata;
	engine: WAHAWebhookStateChangeEngine;
	/**
	 * It’s an internal engine’s state, not session status.
	 * @deprecated
	 */
	event: WAHAWebhookStateChangeEvent;
	payload: WAHAWebhookStateChangePayload;
	me?: MeInfo;
