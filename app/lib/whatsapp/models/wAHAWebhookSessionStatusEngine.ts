...
export type WAHAWebhookSessionStatusEngine =
	(typeof WAHAWebhookSessionStatusEngine)[keyof typeof WAHAWebhookSessionStatusEngine];

export const WAHAWebhookSessionStatusEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
