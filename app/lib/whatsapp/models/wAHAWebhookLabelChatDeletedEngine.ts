...
export type WAHAWebhookLabelChatDeletedEngine =
	(typeof WAHAWebhookLabelChatDeletedEngine)[keyof typeof WAHAWebhookLabelChatDeletedEngine];

export const WAHAWebhookLabelChatDeletedEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
