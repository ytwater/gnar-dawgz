 ...
 */
import type { GroupsControllerGetGroupsExcludeItem } from "./groupsControllerGetGroupsExcludeItem";
import type { GroupsControllerGetGroupsSortBy } from "./groupsControllerGetGroupsSortBy";
import type { GroupsControllerGetGroupsSortOrder } from "./groupsControllerGetGroupsSortOrder";

export type GroupsControllerGetGroupsParams = {
	/**
	 * Sort by field
	 */
	sortBy?: GroupsControllerGetGroupsSortBy;
	/**
	 * Sort order - <b>desc</b>ending (Z => A, New first) or <b>asc</b>ending (A => Z, Old first)
	 */
	sortOrder?: GroupsControllerGetGroupsSortOrder;
	limit?: number;
	offset?: number;
	/**
	 * Exclude fields
	 */
	exclude?: GroupsControllerGetGroupsExcludeItem[];
};
