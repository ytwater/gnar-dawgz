 ...
 */
export type EventResponsePayloadSource =
	(typeof EventResponsePayloadSource)[keyof typeof EventResponsePayloadSource];

export const EventResponsePayloadSource = {
	api: "api",
	app: "app",
} as const;
