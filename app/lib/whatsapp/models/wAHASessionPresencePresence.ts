...
export type WAHASessionPresencePresence =
	(typeof WAHASessionPresencePresence)[keyof typeof WAHASessionPresencePresence];

export const WAHASessionPresencePresence = {
	offline: "offline",
	online: "online",
	typing: "typing",
	recording: "recording",
