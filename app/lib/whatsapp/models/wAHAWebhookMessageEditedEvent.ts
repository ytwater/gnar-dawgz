 ...
 */
export type WAHAWebhookMessageEditedEvent =
	(typeof WAHAWebhookMessageEditedEvent)[keyof typeof WAHAWebhookMessageEditedEvent];

export const WAHAWebhookMessageEditedEvent = {
