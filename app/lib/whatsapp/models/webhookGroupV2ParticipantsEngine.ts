...
export type WebhookGroupV2ParticipantsEngine =
	(typeof WebhookGroupV2ParticipantsEngine)[keyof typeof WebhookGroupV2ParticipantsEngine];

export const WebhookGroupV2ParticipantsEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
