 ...
 */
import type { _GroupV2UpdateEventData } from "./_groupV2UpdateEventData";
import type { GroupV2UpdateEventGroup } from "./groupV2UpdateEventGroup";

export interface GroupV2UpdateEvent {
	/** Unix timestamp */
	timestamp: number;
	group: GroupV2UpdateEventGroup;
	_data: _GroupV2UpdateEventData;
}
