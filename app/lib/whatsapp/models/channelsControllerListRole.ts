...
export type ChannelsControllerListRole =
	(typeof ChannelsControllerListRole)[keyof typeof ChannelsControllerListRole];

export const ChannelsControllerListRole = {
	OWNER: "OWNER",
	ADMIN: "ADMIN",
