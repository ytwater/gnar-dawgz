...
export type WAHAWebhookMessageAckEngine =
	(typeof WAHAWebhookMessageAckEngine)[keyof typeof WAHAWebhookMessageAckEngine];

export const WAHAWebhookMessageAckEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
