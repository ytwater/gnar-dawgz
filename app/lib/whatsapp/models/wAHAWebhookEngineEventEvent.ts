 ...
 */
export type WAHAWebhookEngineEventEvent =
	(typeof WAHAWebhookEngineEventEvent)[keyof typeof WAHAWebhookEngineEventEvent];

export const WAHAWebhookEngineEventEvent = {
