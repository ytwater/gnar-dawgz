...
import type { WAHAWebhookMessageRevokedEngine } from "./wAHAWebhookMessageRevokedEngine";
import type { WAHAWebhookMessageRevokedEvent } from "./wAHAWebhookMessageRevokedEvent";
import type { WAHAWebhookMessageRevokedMetadata } from "./wAHAWebhookMessageRevokedMetadata";
...
export interface WAHAWebhookMessageRevoked {
	...
	metadata?: WAHAWebhookMessageRevokedMetadata;
	engine: WAHAWebhookMessageRevokedEngine;
	/** The event is triggered when a user, whether it be you or any other participant, revokes a previously sent message. */
	event: WAHAWebhookMessageRevokedEvent;
