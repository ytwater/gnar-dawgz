 ...
 */
import type { VideoRemoteFileFilename } from "./videoRemoteFileFilename";
import type { VideoRemoteFileMimetype } from "./videoRemoteFileMimetype";

export interface VideoRemoteFile {
	/** MIME type of the attachment. */
	mimetype: VideoRemoteFileMimetype;
	/** Document file name. Optional */
	filename: VideoRemoteFileFilename;
	url: string;
}
