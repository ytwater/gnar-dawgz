...
export type ChattingControllerGetMessagesFilterAck =
	(typeof ChattingControllerGetMessagesFilterAck)[keyof typeof ChattingControllerGetMessagesFilterAck];

export const ChattingControllerGetMessagesFilterAck = {
	ERROR: "ERROR",
	PENDING: "PENDING",
	SERVER: "SERVER",
	DEVICE: "DEVICE",
