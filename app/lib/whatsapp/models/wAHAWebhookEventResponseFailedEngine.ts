...
export type WAHAWebhookEventResponseFailedEngine =
	(typeof WAHAWebhookEventResponseFailedEngine)[keyof typeof WAHAWebhookEventResponseFailedEngine];

export const WAHAWebhookEventResponseFailedEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
