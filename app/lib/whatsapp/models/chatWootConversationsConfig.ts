 ...
 */
import type { ChatWootConversationsConfigSort } from "./chatWootConversationsConfigSort";
import type { ChatWootConversationsConfigStatusItem } from "./chatWootConversationsConfigStatusItem";
...
export interface ChatWootConversationsConfig {
	...
	markAsRead?: boolean;
	sort: ChatWootConversationsConfigSort;
	status: ChatWootConversationsConfigStatusItem[] | null;
}
