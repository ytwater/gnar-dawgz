 ...
 */
import type { ChatsControllerGetChatMessagesFilterAck } from "./chatsControllerGetChatMessagesFilterAck";
import type { ChatsControllerGetChatMessagesSortBy } from "./chatsControllerGetChatMessagesSortBy";
import type { ChatsControllerGetChatMessagesSortOrder } from "./chatsControllerGetChatMessagesSortOrder";

export type ChatsControllerGetChatMessagesParams = {
	/**
	 * Sort by field
	 */
	sortBy?: ChatsControllerGetChatMessagesSortBy;
	/**
	 * Sort order - <b>desc</b>ending (Z => A, New first) or <b>asc</b>ending (A => Z, Old first)
	 */
	sortOrder?: ChatsControllerGetChatMessagesSortOrder;
	/**
	 ...
	 */
	"filter.ack"?: ChatsControllerGetChatMessagesFilterAck;
};
