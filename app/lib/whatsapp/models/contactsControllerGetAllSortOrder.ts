...
export type ContactsControllerGetAllSortOrder =
	(typeof ContactsControllerGetAllSortOrder)[keyof typeof ContactsControllerGetAllSortOrder];

export const ContactsControllerGetAllSortOrder = {
	desc: "desc",
	asc: "asc",
} as const;
