...
import type { WAHAWebhookMessageEngine } from "./wAHAWebhookMessageEngine";
import type { WAHAWebhookMessageEvent } from "./wAHAWebhookMessageEvent";
import type { WAHAWebhookMessageMetadata } from "./wAHAWebhookMessageMetadata";
...
export interface WAHAWebhookMessage {
	...
	metadata?: WAHAWebhookMessageMetadata;
	engine: WAHAWebhookMessageEngine;
	/** Incoming message. */
	event: WAHAWebhookMessageEvent;
	payload: WAMessage;
	me?: MeInfo;
