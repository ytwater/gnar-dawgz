 ...
 */
export type WAHAWebhookLabelUpsertEvent =
	(typeof WAHAWebhookLabelUpsertEvent)[keyof typeof WAHAWebhookLabelUpsertEvent];

export const WAHAWebhookLabelUpsertEvent = {
