...
export type WAHAPresenceDataLastKnownPresence =
	(typeof WAHAPresenceDataLastKnownPresence)[keyof typeof WAHAPresenceDataLastKnownPresence];

export const WAHAPresenceDataLastKnownPresence = {
	offline: "offline",
	online: "online",
	typing: "typing",
	recording: "recording",
