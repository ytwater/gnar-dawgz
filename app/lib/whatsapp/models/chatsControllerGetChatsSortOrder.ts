...
export type ChatsControllerGetChatsSortOrder =
	(typeof ChatsControllerGetChatsSortOrder)[keyof typeof ChatsControllerGetChatsSortOrder];

export const ChatsControllerGetChatsSortOrder = {
	desc: "desc",
	asc: "asc",
} as const;
