...
export type WAHAWebhookLabelDeletedEngine =
	(typeof WAHAWebhookLabelDeletedEngine)[keyof typeof WAHAWebhookLabelDeletedEngine];

export const WAHAWebhookLabelDeletedEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
