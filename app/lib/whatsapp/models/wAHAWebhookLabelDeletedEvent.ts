 ...
 */
export type WAHAWebhookLabelDeletedEvent =
	(typeof WAHAWebhookLabelDeletedEvent)[keyof typeof WAHAWebhookLabelDeletedEvent];

export const WAHAWebhookLabelDeletedEvent = {
