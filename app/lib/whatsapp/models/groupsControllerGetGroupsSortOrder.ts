...
export type GroupsControllerGetGroupsSortOrder =
	(typeof GroupsControllerGetGroupsSortOrder)[keyof typeof GroupsControllerGetGroupsSortOrder];

export const GroupsControllerGetGroupsSortOrder = {
	desc: "desc",
	asc: "asc",
} as const;
