...
import type { WAHAWebhookGroupJoinEngine } from "./wAHAWebhookGroupJoinEngine";
import type { WAHAWebhookGroupJoinEvent } from "./wAHAWebhookGroupJoinEvent";
import type { WAHAWebhookGroupJoinMetadata } from "./wAHAWebhookGroupJoinMetadata";
import type { WAHAWebhookGroupJoinPayload } from "./wAHAWebhookGroupJoinPayload";
...
export interface WAHAWebhookGroupJoin {
	...
	metadata?: WAHAWebhookGroupJoinMetadata;
	engine: WAHAWebhookGroupJoinEngine;
	/**
	 * Some one join a group.
	 * @deprecated
	 */
	event: WAHAWebhookGroupJoinEvent;
	payload: WAHAWebhookGroupJoinPayload;
	me?: MeInfo;
