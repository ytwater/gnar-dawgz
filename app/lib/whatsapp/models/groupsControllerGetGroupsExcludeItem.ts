...
export type GroupsControllerGetGroupsExcludeItem =
	(typeof GroupsControllerGetGroupsExcludeItem)[keyof typeof GroupsControllerGetGroupsExcludeItem];

export const GroupsControllerGetGroupsExcludeItem = {
	"": "",
