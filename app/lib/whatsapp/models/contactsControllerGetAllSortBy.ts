...
export type ContactsControllerGetAllSortBy =
	(typeof ContactsControllerGetAllSortBy)[keyof typeof ContactsControllerGetAllSortBy];

export const ContactsControllerGetAllSortBy = {
	id: "id",
	name: "name",
} as const;
