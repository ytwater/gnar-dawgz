...
import type { WAHAWebhookLabelChatDeletedEngine } from "./wAHAWebhookLabelChatDeletedEngine";
import type { WAHAWebhookLabelChatDeletedEvent } from "./wAHAWebhookLabelChatDeletedEvent";
import type { WAHAWebhookLabelChatDeletedMetadata } from "./wAHAWebhookLabelChatDeletedMetadata";
...
export interface WAHAWebhookLabelChatDeleted {
	...
	metadata?: WAHAWebhookLabelChatDeletedMetadata;
	engine: WAHAWebhookLabelChatDeletedEngine;
	/** The event is triggered when a label is deleted from a chat */
	event: WAHAWebhookLabelChatDeletedEvent;
