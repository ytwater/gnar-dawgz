 ...
 */
export type WAHAWebhookMessageAnyEvent =
	(typeof WAHAWebhookMessageAnyEvent)[keyof typeof WAHAWebhookMessageAnyEvent];

export const WAHAWebhookMessageAnyEvent = {
