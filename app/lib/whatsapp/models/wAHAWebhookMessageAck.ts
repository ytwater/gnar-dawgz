...
import type { WAHAWebhookMessageAckEngine } from "./wAHAWebhookMessageAckEngine";
import type { WAHAWebhookMessageAckEvent } from "./wAHAWebhookMessageAckEvent";
import type { WAHAWebhookMessageAckMetadata } from "./wAHAWebhookMessageAckMetadata";
...
export interface WAHAWebhookMessageAck {
	...
	metadata?: WAHAWebhookMessageAckMetadata;
	engine: WAHAWebhookMessageAckEngine;
	/** Receive events when server or recipient gets the message, read or played it (contacts only). */
	event: WAHAWebhookMessageAckEvent;
