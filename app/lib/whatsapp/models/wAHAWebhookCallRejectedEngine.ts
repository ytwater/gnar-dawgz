...
export type WAHAWebhookCallRejectedEngine =
	(typeof WAHAWebhookCallRejectedEngine)[keyof typeof WAHAWebhookCallRejectedEngine];

export const WAHAWebhookCallRejectedEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
