...
export type WAHAWebhookGroupJoinEngine =
	(typeof WAHAWebhookGroupJoinEngine)[keyof typeof WAHAWebhookGroupJoinEngine];

export const WAHAWebhookGroupJoinEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
