...
export type WAHAWebhookMessageRevokedEngine =
	(typeof WAHAWebhookMessageRevokedEngine)[keyof typeof WAHAWebhookMessageRevokedEngine];

export const WAHAWebhookMessageRevokedEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
