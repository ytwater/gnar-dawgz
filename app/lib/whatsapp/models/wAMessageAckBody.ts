 ...
 */
import type { _WAMessageAckBodyData } from "./_wAMessageAckBodyData";
import type { WAMessageAckBodyAck } from "./wAMessageAckBodyAck";
...
export interface WAMessageAckBody {
	...
	participant: string;
	fromMe: boolean;
	ack: WAMessageAckBodyAck;
	ackName: string;
	_data?: _WAMessageAckBodyData;
}
