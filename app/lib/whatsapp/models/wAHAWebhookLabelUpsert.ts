...
import type { WAHAWebhookLabelUpsertEngine } from "./wAHAWebhookLabelUpsertEngine";
import type { WAHAWebhookLabelUpsertEvent } from "./wAHAWebhookLabelUpsertEvent";
import type { WAHAWebhookLabelUpsertMetadata } from "./wAHAWebhookLabelUpsertMetadata";
...
export interface WAHAWebhookLabelUpsert {
	...
	metadata?: WAHAWebhookLabelUpsertMetadata;
	engine: WAHAWebhookLabelUpsertEngine;
	/** The event is triggered when a label is created or updated */
	event: WAHAWebhookLabelUpsertEvent;
	payload: Label;
	me?: MeInfo;
