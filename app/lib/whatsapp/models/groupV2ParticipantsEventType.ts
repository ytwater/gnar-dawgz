 ...
 * Type of the event
 */
export type GroupV2ParticipantsEventType =
	(typeof GroupV2ParticipantsEventType)[keyof typeof GroupV2ParticipantsEventType];

export const GroupV2ParticipantsEventType = {
	join: "join",
	leave: "leave",
	promote: "promote",
	demote: "demote",
