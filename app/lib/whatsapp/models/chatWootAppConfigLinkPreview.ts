...
export type ChatWootAppConfigLinkPreview =
	(typeof ChatWootAppConfigLinkPreview)[keyof typeof ChatWootAppConfigLinkPreview];

export const ChatWootAppConfigLinkPreview = {
	OFF: "OFF",
	LG: "LG",
	HG: "HG",
} as const;
