...
export type WAHAWebhookPresenceUpdateEngine =
	(typeof WAHAWebhookPresenceUpdateEngine)[keyof typeof WAHAWebhookPresenceUpdateEngine];

export const WAHAWebhookPresenceUpdateEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
