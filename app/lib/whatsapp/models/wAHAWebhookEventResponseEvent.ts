 ...
 */
export type WAHAWebhookEventResponseEvent =
	(typeof WAHAWebhookEventResponseEvent)[keyof typeof WAHAWebhookEventResponseEvent];

export const WAHAWebhookEventResponseEvent = {
