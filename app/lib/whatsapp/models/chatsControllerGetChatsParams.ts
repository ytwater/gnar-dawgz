 ...
 */
import type { ChatsControllerGetChatsSortBy } from "./chatsControllerGetChatsSortBy";
import type { ChatsControllerGetChatsSortOrder } from "./chatsControllerGetChatsSortOrder";

export type ChatsControllerGetChatsParams = {
	/**
	 * Sort by field
	 */
	sortBy?: ChatsControllerGetChatsSortBy;
	/**
	 * Sort order - <b>desc</b>ending (Z => A, New first) or <b>asc</b>ending (A => Z, Old first)
	 */
	sortOrder?: ChatsControllerGetChatsSortOrder;
	limit?: number;
	offset?: number;
};
