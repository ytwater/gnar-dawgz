 ...
 * @deprecated
 */
export type WAHAWebhookGroupLeaveEvent =
	(typeof WAHAWebhookGroupLeaveEvent)[keyof typeof WAHAWebhookGroupLeaveEvent];

export const WAHAWebhookGroupLeaveEvent = {
