 ...
 */
import type { VideoBinaryFileFilename } from "./videoBinaryFileFilename";
import type { VideoBinaryFileMimetype } from "./videoBinaryFileMimetype";

export interface VideoBinaryFile {
	/** MIME type of the attachment. */
	mimetype: VideoBinaryFileMimetype;
	/** Document file name. Optional */
	filename: VideoBinaryFileFilename;
