...
export type GroupsControllerGetGroupsSortBy =
	(typeof GroupsControllerGetGroupsSortBy)[keyof typeof GroupsControllerGetGroupsSortBy];

export const GroupsControllerGetGroupsSortBy = {
	id: "id",
	subject: "subject",
} as const;
