...
import type { WAHAWebhookCallRejectedEngine } from "./wAHAWebhookCallRejectedEngine";
import type { WAHAWebhookCallRejectedEvent } from "./wAHAWebhookCallRejectedEvent";
import type { WAHAWebhookCallRejectedMetadata } from "./wAHAWebhookCallRejectedMetadata";
...
export interface WAHAWebhookCallRejected {
	...
	metadata?: WAHAWebhookCallRejectedMetadata;
	engine: WAHAWebhookCallRejectedEngine;
	/** The event is triggered when the call is rejected by the user. */
	event: WAHAWebhookCallRejectedEvent;
	payload: CallData;
	me?: MeInfo;
