 ...
 */
export type WAHAWebhookMessageAckGroupEvent =
	(typeof WAHAWebhookMessageAckGroupEvent)[keyof typeof WAHAWebhookMessageAckGroupEvent];

export const WAHAWebhookMessageAckGroupEvent = {
