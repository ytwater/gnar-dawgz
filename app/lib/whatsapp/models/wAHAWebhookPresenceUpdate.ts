...
import type { WAHAWebhookPresenceUpdateEngine } from "./wAHAWebhookPresenceUpdateEngine";
import type { WAHAWebhookPresenceUpdateEvent } from "./wAHAWebhookPresenceUpdateEvent";
import type { WAHAWebhookPresenceUpdateMetadata } from "./wAHAWebhookPresenceUpdateMetadata";
...
export interface WAHAWebhookPresenceUpdate {
	...
	metadata?: WAHAWebhookPresenceUpdateMetadata;
	engine: WAHAWebhookPresenceUpdateEngine;
	/** The most recent presence information for a chat. */
	event: WAHAWebhookPresenceUpdateEvent;
