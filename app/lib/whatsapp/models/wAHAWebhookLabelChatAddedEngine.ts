...
export type WAHAWebhookLabelChatAddedEngine =
	(typeof WAHAWebhookLabelChatAddedEngine)[keyof typeof WAHAWebhookLabelChatAddedEngine];

export const WAHAWebhookLabelChatAddedEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
