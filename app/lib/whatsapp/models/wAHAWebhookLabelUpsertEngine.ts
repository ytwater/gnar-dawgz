...
export type WAHAWebhookLabelUpsertEngine =
	(typeof WAHAWebhookLabelUpsertEngine)[keyof typeof WAHAWebhookLabelUpsertEngine];

export const WAHAWebhookLabelUpsertEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
