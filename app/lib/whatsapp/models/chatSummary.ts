 ...
 */
import type { _ChatSummaryChat } from "./_chatSummaryChat";
import type { ChatSummaryLastMessage } from "./chatSummaryLastMessage";

export interface ChatSummary {
	id: string;
	name: string | null;
	picture: string | null;
	lastMessage: ChatSummaryLastMessage;
	_chat: _ChatSummaryChat;
}
