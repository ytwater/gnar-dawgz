 ...
 */
export type WAHAWebhookCallReceivedEvent =
	(typeof WAHAWebhookCallReceivedEvent)[keyof typeof WAHAWebhookCallReceivedEvent];

export const WAHAWebhookCallReceivedEvent = {
