...
import type { WAHAWebhookEventResponseEngine } from "./wAHAWebhookEventResponseEngine";
import type { WAHAWebhookEventResponseEvent } from "./wAHAWebhookEventResponseEvent";
import type { WAHAWebhookEventResponseMetadata } from "./wAHAWebhookEventResponseMetadata";
...
export interface WAHAWebhookEventResponse {
	...
	metadata?: WAHAWebhookEventResponseMetadata;
	engine: WAHAWebhookEventResponseEngine;
	/** The event is triggered when the event response is received. */
	event: WAHAWebhookEventResponseEvent;
