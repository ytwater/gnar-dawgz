...
import type { WAHAWebhookMessageAckGroupEngine } from "./wAHAWebhookMessageAckGroupEngine";
import type { WAHAWebhookMessageAckGroupEvent } from "./wAHAWebhookMessageAckGroupEvent";
import type { WAHAWebhookMessageAckGroupMetadata } from "./wAHAWebhookMessageAckGroupMetadata";
...
export interface WAHAWebhookMessageAckGroup {
	...
	metadata?: WAHAWebhookMessageAckGroupMetadata;
	engine: WAHAWebhookMessageAckGroupEngine;
	/** Receive events when participants in a group read or play messages. */
	event: WAHAWebhookMessageAckGroupEvent;
