...
export type SessionsControllerListExpandItem =
	(typeof SessionsControllerListExpandItem)[keyof typeof SessionsControllerListExpandItem];

export const SessionsControllerListExpandItem = {
	apps: "apps",
} as const;
