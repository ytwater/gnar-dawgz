...
export type ChatsControllerGetChatMessagesSortBy =
	(typeof ChatsControllerGetChatMessagesSortBy)[keyof typeof ChatsControllerGetChatMessagesSortBy];

export const ChatsControllerGetChatMessagesSortBy = {
	timestamp: "timestamp",
