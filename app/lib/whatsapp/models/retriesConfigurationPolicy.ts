...
export type RetriesConfigurationPolicy =
	(typeof RetriesConfigurationPolicy)[keyof typeof RetriesConfigurationPolicy];

export const RetriesConfigurationPolicy = {
	linear: "linear",
