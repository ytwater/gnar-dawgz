...
import type { WAHAWebhookEngineEventEngine } from "./wAHAWebhookEngineEventEngine";
import type { WAHAWebhookEngineEventEvent } from "./wAHAWebhookEngineEventEvent";
import type { WAHAWebhookEngineEventMetadata } from "./wAHAWebhookEngineEventMetadata";
...
export interface WAHAWebhookEngineEvent {
	...
	metadata?: WAHAWebhookEngineEventMetadata;
	engine: WAHAWebhookEngineEventEngine;
	/** Internal engine event. */
	event: WAHAWebhookEngineEventEvent;
