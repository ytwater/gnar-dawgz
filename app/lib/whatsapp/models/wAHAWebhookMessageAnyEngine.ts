...
export type WAHAWebhookMessageAnyEngine =
	(typeof WAHAWebhookMessageAnyEngine)[keyof typeof WAHAWebhookMessageAnyEngine];

export const WAHAWebhookMessageAnyEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
