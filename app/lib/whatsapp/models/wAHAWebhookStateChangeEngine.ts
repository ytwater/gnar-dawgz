...
export type WAHAWebhookStateChangeEngine =
	(typeof WAHAWebhookStateChangeEngine)[keyof typeof WAHAWebhookStateChangeEngine];

export const WAHAWebhookStateChangeEngine = {
	WEBJS: "WEBJS",
	NOWEB: "NOWEB",
	GOWS: "GOWS",
} as const;
